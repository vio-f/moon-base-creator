...
/**
 * @author Tom Gaskins
 * @version $Id: AVKey.java 14725 2011-02-16 07:11:33Z tgaskins $
 */
public interface AVKey // TODO: Eliminate unused constants, if any
{
    ...
    final String KML_USE_BROWSER_BALLOON = "gov.nasa.worldwind.avkey.KMLUseBrowserBalloon";
    ...
    final String NAVIGATION_TARGET_CURRENT_BROWSER = "gov.nasa.worldwind.avkey.NavigationTargetCurrentBrowser";
    final String NAVIGATION_TARGET_NEW_BROWSER = "gov.nasa.worldwind.avkey.NavigationTargetNewBrowser";
    final String NAVIGATION_TYPE = "gov.nasa.worldwind.avkey.NavigationType";
    final String NAVIGATION_TYPE_BROWSER_INITIATED = "gov.nasa.worldwind.avkey.NavigationTypeBrowserInitiated";
    final String NAVIGATION_TYPE_LINK_ACTIVATED = "gov.nasa.worldwind.avkey.NavigationTypeLinkActivated";
    ...
    final String WEB_VIEW_REFRESH_INTERVAL = "gov.nasa.worldwind.avkey.WebViewRefreshInterval";
