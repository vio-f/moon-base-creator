 ...
 *
 * @author pabercrombie
 * @version $Id: HotSpotController.java 14488 2011-01-18 18:22:43Z pabercrombie $
 */
public class HotSpotController implements SelectListener
{
    ...
    protected void setActiveHotSpot(HotSpot hotSpot)
    {
        ...
        if (this.wwd instanceof Component)
        {
            ...
            // Give the new HotSpot a chance to set a custom cursor. Do this even if the HotSpot is already active
            // because the cursor may change depending on where the mouse is in the HotSpot.
            if (hotSpot != null)
            {
