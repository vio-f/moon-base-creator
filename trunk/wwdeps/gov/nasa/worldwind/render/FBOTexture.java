...
/**
 * @author tag
 * @version $Id: FBOTexture.java 14563 2011-01-26 21:22:00Z tgaskins $
 */
public class FBOTexture extends FramebufferTexture
{
    ...
    protected Texture initializeTexture(DrawContext dc)
    {
        ...
        if (this.sourceTexture != null && dc.getTextureCache().getTexture(sourceTexture.getImageSource()) == null)
        {
