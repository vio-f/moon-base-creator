...
public class Box extends AbstractShape
{
    ...
    /**
     * Indicates this Box's center position.
     *
     * @return this Box's center position.
     */
    ...
    /**
     * Specifies this Box's center position.
     *
     * @param centerPosition this Box's center position.
     */
    ...
    /**
     * Returns the Box's referencePosition, which is essentially its centerPosition
     *
     * @return the centerPosition of the Box
     */
    ...
    /**
     * Indicates the radius of this Box's axis in the north-south (latitudinal) direction.
     *
     * @return this Box's radius in the north-south direction.
     */
    ...
    /**
     * Specifies this Box's radius in meters in the north-south (latitudinal) direction.
     * The radius must be greater than 0.
     *
     * @param northSouthRadius the Box radius in the north-south direction. Must be greater than 0.
     *
    ...
    /**
     * Indicates the radius of this Box's axis in the east-west (longitudinal) direction.
     *
     * @return this Box's radius in the east-west direction.
     */
    ...
    /**
     * Specifies this Box's radius in meters in the east-west (longitudinal) direction.
     * The radius must be greater than 0.
     *
     * @param eastWestRadius the Box radius in the east-west direction. Must be greater than 0.
     *
     * @throws IllegalArgumentException if the radius is not greater than 0.
     */
    ...
    /**
     * Indicates the radius of this Box's axis in the vertical (altitudinal) direction.
     *
     * @return this Box's radius in the vertical direction.
     */
    ...
    /**
     * Specifies this Box's radius in meters in the vertical (altitudinal) direction. The radius must be greater than
     * 0.
     *
     * @param verticalRadius the Box radius in the vertical direction. Must be greater than 0.
     *
     * @throws IllegalArgumentException if the radius is not greater than 0.
     */
    ...
    /**
     * Indicates this Box's azimuth, its rotation about its vertical axis. North corresponds to an azimuth of 0. Angles
     * are in degrees and positive counter-clockwise.
     *
     * @return this Box's azimuth.
     */
    ...
    /**
     * Specifies this Box's azimuth, its rotation about its vertical axis. North corresponds to an azimuth of 0. Angles
     * are in degrees and positive counter-clockwise.
     *
     * @param heading the Box's azimuth, in degrees.
     */
    ...
    /**
     * Indicates this Box's pitch, its rotation about its east-west axis. Angles are positive counter-clockwise.
     *
     * @return this Box's azimuth.
     */
    ...
    /**
     * Specifies this Box's pitch, its rotation about its east-west axis. Angles are positive counter-clockwise.
     *
     * @param tilt the Box's pitch, in degrees.
     */
    ...
    /**
     * Indicates this Box's roll, its rotation about its north-south axis. Angles are positive counter-clockwise.
     *
     * @return this Box's azimuth.
     */
    ...
    /**
     * Specifies this Box's roll, its rotation about its north-south axis. Angles are in degrees and positive
     * counter-clockwise.
     *
     * @param roll the Box's azimuth, in degrees.
     */
    ...
    /**
     * Retrieves the Box's scaling factor along its north-south axis.
     *
     * @return this Box's north-south scaling factor.
     */
    ...
    /**
     * Specifies this Box's scaling factor along its north-south axis.
     *
     * @param northSouthScalingFactor the Box's north-south scaling factor.
     */
    ...
    /**
     * Retrieves the Box's scaling factor along its vertical axis.
     *
     * @return this Box's vertical scaling factor.
     */
    ...
    /**
     * Specifies this Box's scaling factor along its vertical axis.
     *
     * @param verticalScalingFactor the Box's vertical scaling factor.
     */
    ...
    /**
     * Retrieves the Box's scaling factor along its east-west axis.
     *
     * @return this Box's east-west scaling factor.
     */
    ...
    /**
     * Specifies this Box's scaling factor along its east-west axis.
     *
     * @param eastWestScalingFactor the box's east-west scaling factor.
     */
    ...
    /**
     * Indicates the image source for this Box's optional texture.
     *
     * @return the image source of the Box's texture.
     */
    ...
    /**
     * Specifies the image source for this Box's optional texture.
     *
    ...
    /**
     * Get the texture applied to this Box. The texture is loaded on a background thread. This method will return null
    ...
    protected boolean doMakeOrderedRenderable(DrawContext dc)
    {
        ...
        if (shapeData.getMesh().getBuffer(Geometry.VERTEX) != null)
        {
            ...
            //shapeData.setExtent(this.getExtent(dc.getGlobe(), dc.getVerticalExaggeration()));
        }
    ...
    protected void doDrawInterior(DrawContext dc)
    {
        ...
        {
            gov.nasa.worldwind.geom.Box extent = (gov.nasa.worldwind.geom.Box) this.getExtent();
            extent.render(dc);
        }
        ...
        if (mustApplyTexture(dc))
        {
            ...
            gl.glTexCoordPointer(2, GL.GL_FLOAT, 0,
                this.getCurrentShapeData().getMesh().getBuffer(Geometry.TEXTURE).rewind());
    ...
    /**
     * Computes the Box's extent using a bounding box.
     *
    ...
    /**
     * Computes the Box's sector.  Not currently supported.
     *
    ...
    /**
     * Sets the Box's referencePoint, which is essentially its centerPosition in Cartesian coordinates.
     *
     * @param dc the current DrawContext
     *
     * @return the computed reference point, or null if the point cannot be computed.
     */
     ...
     * @param verticalExaggeration the current vertical exaggeration
     *
     * @return the box's referencePoint
     */
     ...
     * correct Box location, orientation and scale
     *
     * @param globe                the current globe
     * @param verticalExaggeration the current vertical exaggeration
     *
    ...
    protected Matrix computeRenderMatrix(DrawContext dc)
    {
        ...
        matrix = matrix.multiply(dc.getGlobe().computeModelCoordinateOriginTransform(refPosition));
    ...
    protected void makeGeometry(ShapeData shapeData)
    {
        ...
        Object cacheKey = new Geometry.CacheKey(this.getClass(), "Box", this.subdivisions);
        Geometry geom = (Geometry) this.getGeometryCache().getObject(cacheKey);
        if (geom == null)
        {
            // if none exists, create a new one
            shapeData.setMesh(new Geometry());
            makeUnitBox(this.subdivisions, shapeData.getMesh());
    ...
    /**
     * Move the Box to the specified destination.
     *
