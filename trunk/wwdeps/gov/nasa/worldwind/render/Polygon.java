 ...
 *
 * @author tag
 * @version $Id: Polygon.java 14741 2011-02-16 23:36:47Z tgaskins $
 */
public class Polygon extends AbstractShape
{
    ...
    {
        return !dc.isPickingMode() && this.getTexture() != null && this.textureCoordsBuffer != null;
    }
...
//            dc.drawNormals(1000, this.boundarySet.coordBuffer, this.boundarySet.normalBuffer);
    ...
    protected void fillVBO(DrawContext dc)
    {
        ...
        if (vboIds == null)
        {
            ...
            dc.getGpuResourceCache().put(shapeData, vboIds, GpuResourceCache.VBO_BUFFERS, size);
//            shapeData.setVboCacheKey(vboIds);
     ...
     * (see {@link WorldWindow#addRenderingExceptionListener(gov.nasa.worldwind.event.RenderingExceptionListener)}).
     *
     * @param dc        the draw context.
     * @param shapeData the current shape data for this shape.
     */
    protected void createTessllationGeometry(DrawContext dc, ShapeData shapeData)
    {
        ...
        try
        {
            Vec4 normal = Vec4.normalVector3(shapeData.coordBuffer, 0);
            if (normal == null)
            {
