 ...
 *
 * @author pabercrombie
 * @version $Id: AbstractKMLBalloon.java 14736 2011-02-16 20:25:19Z dcollins $
 */
public abstract class AbstractKMLBalloon implements Balloon
{
     ...
     */
    public AbstractKMLBalloon(KMLAbstractFeature feature)
    {
        if (feature == null)
        {
    ...
    public void render(DrawContext dc)
    {
        ...
        if (balloon.isHighlighted())
        {
            BalloonAttributes b = balloon.getHighlightAttributes();
        ...
        {
            BalloonAttributes b = balloon.getAttributes();
            if (b == null || b.isUnresolved())
            {
    ...
    protected void makeAttributesCurrent(String attrType)
    {
        BalloonAttributes attrs = this.getInitialBalloonAttributes(
            this.getBalloon().isHighlighted() ? KMLConstants.HIGHLIGHT : KMLConstants.NORMAL);
