...
/**
 * @author dcollins
 * @version $Id: Vec4.java 14741 2011-02-16 23:36:47Z tgaskins $
 */
public class Vec4
{
...
//    }
    ...
    /**
     * Computes a non-unit-length normal vector for a buffer of coordinate triples. The normal vector is computed from
     * the first three non-colinear points in the buffer.
     *
     ...
     *
     * @return the computed normal vector, or null if a normal vector could not be computed. The vector returned is not
     *         explicitly normalized to a unit vector.
     */
    public static Vec4 normalVector3(FloatBuffer coords, int stride)
    {
        if (coords == null)
            return null;
        ...
        return vab != null && vbc != null ? vab.cross3(vbc) : null;
    }
