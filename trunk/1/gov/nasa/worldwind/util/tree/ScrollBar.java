 ...
 *
 * @author pabercrombie
 * @version $Id: ScrollBar.java 14700 2011-02-13 22:46:28Z pabercrombie $
 */
public class ScrollBar implements Renderable
{
    ...
    protected Insets arrowInsets = new Insets(2, 2, 2, 2);
    ...
    protected long nextAutoScroll;               // Time at which the scrollbar should automatically update itself
    ...
    {
        int arrowSize = this.getScrollArrowHeight();
    ...
    protected void computeBounds()
    {
        ...
        else
        {
            ...
            this.scrollKnobBounds = new Rectangle(knobStart, y1, knobSize, scrollControlSize);
    ...
    /**
     * Draw the vertices of a quadrilateral. This method must be called between {@code glBegin(GL.GL_QUADS)} and
     * {@code glEnd()}.
     *
     * @param dc         Current draw context.
     * @param bounds     Bounds of the quad.
