 ...
 * <code>{@link gov.nasa.worldwind.examples.LayerTreeNode}</code>. a <code>LayerTreeNode</code> may be of any type.
 * <p/>
 ...
 *
 * @author dcollins
 * @version $Id: LayerTreeModel.java 14683 2011-02-13 00:01:25Z dcollins $
 */
public class LayerTreeModel extends BasicTreeModel
{
     ...
     * root should always be of type <code>{@link gov.nasa.worldwind.examples.LayerTreeNode}</code>.
     *
     ...
     * node. Nodes added under this tree model's root should always be of type <code>{@link
     * gov.nasa.worldwind.examples.LayerTreeNode}</code>.
     *
