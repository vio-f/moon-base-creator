...
public abstract class AbstractShape extends WWObjectImpl
    implements Highlightable, OrderedRenderable, Movable, ExtentHolder, GeographicExtent, Exportable
{
     ...
     * #pick} and {@link #render} when it's been determined that the shape is likely to be visible.
     *
     * @param dc the current draw context.
     *
    ...
    /** Holds globe-dependent computed data. One entry per globe encountered during {@link #render}. */
    ...
    {
        protected long frameNumber = -1; // identifies the frame used to calculate these values
    ...
    protected void reset()
    {
        ...
        this.sector = null;
        this.shapeDataCache.setAllExpired(true);
    }
     ...
     *                 <code>GL_CURRENT_BIT, GL_LINE_BIT, GL_HINT_BIT, GL_POLYGON_BIT, GL_COLOR_BUFFER_BIT,
     *                 GL_TEXTURE_BIT and GL_TRANSFORM_BIT</code>.
     *
