 ...
 *
 * @author pabercrombie
 * @version $Id: BalloonAttributes.java 14480 2011-01-15 00:37:02Z dcollins $
 * @see Balloon
 * @see FrameFactory
 */
public interface BalloonAttributes extends ShapeAttributes
{
     ...
     * <code>FrameFactory.SHAPE_RECTANGLE</code>, then the returned <code>Size</code> indicates the rectangle's width
     * and height. If the balloon's shape is <code>FrameFactory.SHAPE_ELLIPSE</code>, then the returned
     * <code>Size</code> indicates the ellipse's x- and y-radii.
     *
     ...
     * <code>FrameFactory.SHAPE_RECTANGLE</code>, then <code>size</code> specifies the rectangle's width and height. If
     * the balloon's shape is <code>FrameFactory.SHAPE_ELLIPSE</code>, then <code>size</code> specifies the ellipse's x-
     * and y-radii.
     * <p/>
     ...
     * <p/>
     * If the balloon's shape is <code>FrameFactory.SHAPE_RECTANGLE</code>, <code>insets</code> specifies the padding
     * between the balloon's content area and the rectangle's top, left, bottom, and right.
     * <p/>
     * If the balloon's shape is <code>FrameFactory.SHAPE_ELLIPSE</code>, <code>insets</code> specifies the padding
     * between the balloon's content area and the ellipse's top, left, bottom, and right apexes.
     *
     ...
     *
     * @return the balloon frame's shape, either {@link gov.nasa.worldwind.render.FrameFactory#SHAPE_RECTANGLE} or
     *         {@link gov.nasa.worldwind.render.FrameFactory#SHAPE_ELLIPSE}.
     *
     ...
     * gov.nasa.worldwind.render.FrameFactory#SHAPE_RECTANGLE}</li> <li>{@link gov.nasa.worldwind.render.FrameFactory#SHAPE_ELLIPSE}</li>
     * </ul>
     * <p/>
     * If the <code>shape</code> is <code>FrameFactory.SHAPE_RECTANGLE</code>, the balloon is displayed as a rectangle
     * in the viewport with optionally rounded corners. The rectangle's dimension in the viewport are specified by
     * calling {@link #setSize(Size)}. The rectangle's corner radius in pixels is specified by calling {@link
     * #setCornerRadius(int)}.
     * <p/>
     * If the <code>shape</code> is <code>FrameFactory.SHAPE_ELLIPSE</code>, the balloon is displayed as an ellipse in
     * the viewport. The ellipse's x- and y-radii are specified by calling {@link #setSize(Size)}. The balloon's corner
     * radius attribute is ignored.
     *
     * @param shape the frame shape to use, either <code>FrameFactory.SHAPE_RECTANGLE</code> or
     *              <code>FrameFactory.SHAPE_ELLIPSE</code>.
     *
     ...
     *
     * @return the balloon leader's shape, either {@link gov.nasa.worldwind.render.FrameFactory#LEADER_NONE} or {@link
     *         gov.nasa.worldwind.render.FrameFactory#LEADER_TRIANGLE}.
     *
     ...
     * gov.nasa.worldwind.render.FrameFactory#LEADER_NONE}</li> <li>{@link gov.nasa.worldwind.render.FrameFactory#LEADER_TRIANGLE}</li>
     * </ul>
     * <p/>
     * If the <code>shape</code> is <code>FrameFactory.LEADER_NONE</code>, the leader is disabled and does not display.
     * <p/>
     * If the <code>shape</code> is <code>FrameFactory.LEADER_TRIANGLE</code>, the leader extends from one side of the
     * balloon's frame and points to the balloon's screen reference point. The width of the leader (in pixels) where it
     * intersects the balloon's frame is specified by calling {@link #setLeaderWidth(int)}.
     *
     * @param shape the leader shape to use, either <code>FrameFactory.LEADER_NONE</code> or
     *              <code>FrameFactory.LEADER_TRIANGLE</code>.
     *
     * @throws IllegalArgumentException if <code>shape</code> is <code>null</code>.
     * @see #getLeaderShape()
     ...
     * <p/>
     * This does nothing if the balloon's leader shape is <code>FrameFactory.LEADER_NONE</code>.
     * <p/>
     * If the balloon's leader shape is <code>FrameFactory.LEADER_TRIANGLE</code>, this specifies the size of the leader
     * where it intersects the balloon's frame.
     *
     ...
     * corners. This value is ignored if the balloon's shape is <code>FrameFactory.SHAPE_ELLIPSE</code>.
     *
