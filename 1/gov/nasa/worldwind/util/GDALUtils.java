 ...
 * @version $Id: GDALUtils.java 14605 2011-01-30 04:47:50Z garakl $
 */
...
//            Logging.logger().info("Debug: GdalLibrariesFinder: searching for " + searchPattern);
            listFolders.clear();
        }
...
//                    Logging.logger().finest(Logging.getMessage("gdal.LibraryLoaderReplacedOK"));
    ...
    protected static boolean gdalLoadNativeLibrary()
    {
        boolean loaded;
    ...
    protected static void initialize()
    {
        try
        {
            ...
            boolean gdalNativeLibraryLoaded = gdalLoadNativeLibrary();
            ...
            if (!gdalNativeLibraryLoaded && !runningAsJavaWebStart)
            {
                ...
                if (newJavaLibraryPath != null)
                {
                    ...
                    gdalNativeLibraryLoaded = gdalLoadNativeLibrary();
                }
            }
