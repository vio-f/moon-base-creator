 ...
 * default, a <code>LayerTree</code> is created with a <code>{@link gov.nasa.worldwind.examples.LayerTreeModel}</code>,
 * and a <code>{@link gov.nasa.worldwind.util.tree.BasicTreeLayout}</code> that is configured for displaying a layer
 * tree. Callers can specify the model to use either by specifying one during construction, or by calling <code>{@link
 ...
 *
 * @author dcollins
 * @version $Id: LayerTree.java 14683 2011-02-13 00:01:25Z dcollins $
 * @see gov.nasa.worldwind.examples.LayerTreeModel
 * @see gov.nasa.worldwind.examples.LayerTreeNode
 */
