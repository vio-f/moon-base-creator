...
/**
 * @author tag
 * @version $Id: RectangularTessellator.java 14635 2011-02-03 07:49:30Z tgaskins $
 */
    ...
    public SectorGeometryList tessellate(DrawContext dc)
    {
        ...
        if (!WorldWind.getMemoryCacheSet().containsCache(CACHE_ID))
        {
            ...
            cache.addCacheListener(new MemoryCache.CacheListener()
            {
                ...
                {
                    String msg = Logging.getMessage("BasicMemoryCache.ExceptionFromRemovalListener");
                    Logging.logger().log(java.util.logging.Level.INFO, msg, e);
                }
            });
