...
/**
 * @author tag
 * @version $Id: AWTInputHandler.java 14226 2010-12-13 19:48:32Z dcollins $
 */
    ...
    Disposable
{
    ...
    */
    ...
    /**
     * Forwards the select event to the input handler's select listeners.
     *
     * @param event the select event to forward.
     */
    public void selected(SelectEvent event)
    {
