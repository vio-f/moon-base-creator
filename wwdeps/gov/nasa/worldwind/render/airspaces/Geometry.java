...
/**
 * @author dcollins
 * @version $Id: Geometry.java 14761 2011-02-19 00:03:45Z ccrick $
 */
public class Geometry extends AVListImpl implements Cacheable
{
    ...
    public boolean getRefillIndexVBO()
    {
        return this.refillIndexVBO;
    }

    public void setRefillIndexVBO(boolean doRefill)
    {
        this.refillIndexVBO = doRefill;
    }
