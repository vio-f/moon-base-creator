...
/**
 * @author tag
 * @version $Id: PolyArc.java 14741 2011-02-16 23:36:47Z tgaskins $
 */
public class PolyArc extends Polygon
{
    ...
    protected Extent computeExtent(Globe globe, double verticalExaggeration)
    {
        ...
        this.makePolyArcLocations(globe, this.getLocationList(), 8, this.polyArcLocations, this.edgeFlags);

        return this.computeBoundingVolume(globe, verticalExaggeration, this.polyArcLocations);
    }
